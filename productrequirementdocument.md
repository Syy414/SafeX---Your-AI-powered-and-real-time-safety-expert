...
### 4.3 Insights tab
**Purpose:** show both personal summary and anonymized community scam trends.

**Sections:**
1) Personal (local-only)
   - “Threats detected this week”
   - “Top category (device)” (optional)
2) Community (Firestore aggregated)
   - Total reports this week
   - Top scam categories (pie/list)
   - Top scam tactics (list)
   - Masked domain patterns (optional)
3) Education cards
   - “Common scam tactics”
